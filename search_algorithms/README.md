...
The Learning Objectives of this project are to be able to explain to anyone :
...
#### [0. Linear Search](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/0-linear.c)
...
#### [1. Binary Search](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/1-binary.c)
...
#### [2. Big O #0](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/2-O)

What is the `time complexity` (worst case) of a linear search in an array of size `n`?

---------------------

#### [3. Big O #1](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/3-O)

What is the `space complexity` (worst case) of an iterative linear search algorithm in an array of size `n`?

-------------------

#### [4. Big O #2](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/4-O)

What is the `time complexity` (worst case) of a binary search in an array of size `n`?

-------------------

#### [5. Big O #3](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/5-O)

What is the `space complexity` (worst case) of a binary search in an array of size `n`?

----------------------

#### [6. Big O #4](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/6-O)
...
#### [7. Jump Search](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/100-jump.c)
...
#### [8. Big O #5](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/101-O)

What is the `time complexity` (average case) of a jump search in an array of size `n`, using `step = sqrt(n)`?

----------------------------

#### [9. Interpolation Search](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/102-interpolation.c)
...
#### [10. Exponential Search](https://github.com/CaroChoch/holbertonschool-low_level_programming/blob/master/search_algorithms/103-exponential.c)
